            ...
            <div class="container">
                ...
                <div class="pricing__wrapper">
                    <div class="pricing__items p--3 my--3 bg--light">
                        <h3 class="text--secondary mb--3"><?php echo get_field('one_type');?></h3>
                        <p class="t--bold mb--2"><?php echo get_field('pricing_details');?></p>
                        <ul class="amount text--primary d--flex justify--center align--center mb--2">
                            <li><h4><?php echo get_field('price1');?></h4></li>
                            <li class="text--left">
                        ...
                        <?php if(get_field('features_1')) : while(the_repeater_field('features_1')): ?>
                            <li>
                            <?php 
                    ...
                    <div class="pricing__items p--3 my--3 bg--secondary">
                        <h3 class="text--secondary mb--3"><?php echo get_field('two_type');?></h3>
                        <p class="t--bold mb--2"><?php echo get_field('pricing_details');?></p>
                        <ul class="amount text--primary d--flex justify--center align--center mb--2">
                            <li><h4><?php echo get_field('price2');?></h4></li>
                            <li class="text--left">
                                <p class="t--bold"><small>$</small></p>
                                <p><small>Per Month</small></p>
                            </li>
                        ...
                        <ul class="includes mb--3">
                             <?php if(get_field('features_2')) : while(the_repeater_field('features_2')): ?>
                            <li>
                            <?php 
                            $image = get_sub_field('check');
                            if(!empty($image)):
                    ...
                    <div class="pricing__items p--3 my--3 bg--light">
                        <h3 class="text--secondary mb--3"><?php echo get_field('three_type');?></h3>
                        <p class="t--bold mb--2"><?php echo get_field('pricing_details');?></p>
                        <ul class="amount text--primary d--flex justify--center align--center mb--2">
                            <li><h4><?php echo get_field('price3');?></h4></li>
                            <li class="text--left">
                                <p class="t--bold"><small>$</small></p>
                                <p><small>Per Month</small></p>
                            </li>
                        ...
                        <ul class="includes mb--3">
                        <?php if(get_field('features_3')) : while(the_repeater_field('features_3')): ?>
                            <li>
                            <?php 
                            $image = get_sub_field('check');
                            if(!empty($image)):
